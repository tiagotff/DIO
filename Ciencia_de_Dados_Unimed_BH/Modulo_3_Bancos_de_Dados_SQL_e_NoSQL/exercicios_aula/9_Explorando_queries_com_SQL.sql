...
-- Recuperando as informações de departamentos de projetos localizados
DESC project;
SELECT Pnumber, Lname, Address, Bdate, p.Plocation FROM departament d, project p, employee e
	WHERE d.Dnumber = p.Dnumber AND p.Plocation = 'Standfford' AND Mgr_ssn = e.Ssn;
    
    
-- Linke e Between
SELECT * FROM employee;

SELECT CONCAT(Fname, ' ', Lname) AS Complete_Name, Dname, Address AS Departament_Name
